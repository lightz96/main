...
public class TypicalOccurrences {
    ...
    public static final Occurrence DAILY_OCCURRENCE = new Occurrence("daily", 2);
    public static final Occurrence WEEKLY_OCCURRENCE = new Occurrence("weekly", 2);
    public static final Occurrence MONTHLY_OCCURRENCE = new Occurrence("monthly", 2);
    public static final Occurrence YEARLY_OCCURRENCE = new Occurrence("yearly", 2);
