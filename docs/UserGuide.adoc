...
TIP: This symbol indicates useful information that may improve your experience with THRIFT.

NOTE: This symbol indicates essential and good to know information.

WARNING: This symbol indicates warning information that you ought to be aware of while using THRIFT.
[horizontal]
...
If you still remember about `add_expense` command but had forgotten about how to use it. You can view a simplified help version of this
