...
The function wrappers to these methods are `Model#keepTrackCommands(Undoable command)`, `Model#getPreviousUndoableCommand()`, `hasUndoableCommand()`,
`Model#getUndoneCommand()` and `hasUndoneCommand()` respectively.
...
image::UndoAndRedo/addExpense.PNG[align="center"]
...
image::UndoAndRedo/updateExpense.PNG[align="center"]
...
image::UndoAndRedo/undo.PNG[align="center"]
...
image::UndoAndRedo/undo2.PNG[align="center"]
...
image::UndoAndRedo/redo.PNG[align="center"]
