...
`currentMonth`:: Text with grey highlight (called a mark-up) indicates that it is a method/variable/setting parameter name.
...
After forking the repo, the documentation will still have the SE-EDU branding and refer to the _se-edu/addressbook-level3_ repo.

If you plan to develop this fork as a separate product (i.e. instead of contributing to _se-edu/addressbook-level3_), you should do the following:
