...
With THRIFT, users can keep track of their incomes and expenses by executing a single command and will not be worried about overspending.
...
All these features will be executed via commands as it is one of the requirements in this module. Below shows how THRIFT looks like:
